...
% Reshape nn_params back into the parameters Theta_x, the weight matrices
% for our multiple layer neural network
num_layers = size(layer_sizes)(1);
...
cpos = log(h_x) .* yk; % size(cleft) = 5000 x 10
cneg = log(1-h_x) .* (1-yk); % size(cright) = 5000 x 10
...
%! assert(J, 7.4070, tol);
%! assert(grad, [0.766138; 0.979897; -0.027540; -0.035844; -0.024929; -0.053862; 0.883417; 0.568762; 0.598139; 0.459314; 0.344618; 0.256313; 0.311885; 0.478337; 0.368920; 0.259771; 0.322331], tol);
